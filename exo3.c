...
if (degat2<= a.esquive)
    {
    printf("Hop, c'est l'esquive de  jb dedicace a %s\n",a.nom);
...
var1.attaque=(float)rand() / ((float)RAND_MAX/5)+5;
var2.attaque=(float)rand() / ((float)RAND_MAX/5)+5;


var1.defense=(float)rand() / ((float)RAND_MAX/2)+2;
var2.defense=(float)rand() / ((float)RAND_MAX/2)+2;

var1.esquive=((float)rand() / (float)RAND_MAX * (0.2 - 0.1) + 0.1);
var2.esquive=((float)rand() / (float)RAND_MAX * (0.2 - 0.1) + 0.1);


var1.points2vie=(float)rand() / ((float)RAND_MAX/20)+80;
var2.points2vie=(float)rand() / ((float)RAND_MAX/20)+80;
